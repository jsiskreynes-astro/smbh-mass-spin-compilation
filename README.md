# SMBH Spin–Mass Compilations (X-ray Reflection Spins)
...
This repository provides an archival compilation of published measurements of supermassive black hole (SMBH) masses and spins derived from X-ray reflection spectroscopy.

The compilation is intended as a transparent and reproducible resource for studies of SMBH growth, accretion, and spin evolution.

The sample currently includes mass and spin measurements for unobscured and mildly obscured active galactic nuclei, as well as ancillary quantities including:

- redshift
- X-ray luminosity
- optical spectral type classification
...
The principal catalogue, first presented in [Sisk-Reynes et al., 2026](https://ui.adsabs.harvard.edu/abs/2026Galax..14...50S/abstract), is available as:

`updated_spin_mass_sample.txt`
...
This repository is distributed under a Creative Commons Attribution 4.0 International License (CC BY 4.0).
